...
def main():
    ...
    with col1:
        ...
        st.write("Este é um painel interativo para visualização das notas dos estudantes.")

    # Conteúdo da coluna direita (logo)
    with col2:
        # Carregar e exibir a imagem (logo)
        st.image("campusHumanitas2.PNG", width=300)  # Substitua "logo.png" pelo caminho da sua imagem
    ...
    if uploaded_file is not None:
        ...
        if bimestre.strip() == "":
            ...
            tab1, tab2, tab3, tab4, tab5, tab6, tab7 = st.tabs(
                ["Visão Geral", "Busca de Estudante", "Estatísticas da Turma", "Ranking de Estudante", "Comparação de Estudante", "Ranking por Disciplina", "BD"]
            )
            ...
            # (O restante do código permanece igual ao que você já tem)
        ...
        # Aba 3: Estatísticas da Turma
            ...
            with tab4:
                st.header(f"Ranking de Estudantes - {bimestre}")
            ...
            with tab5:
                st.header(f"Comparação de Estudantes - {bimestre}")
